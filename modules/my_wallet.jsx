          ...
          <div style={{padding:18}}>
            ...
            <div className="card-inner">
              ...
              <table className="tbl">
                ...
                <tbody>
                  {[
                    ['2026-05-12 09:14','结算入账','STL-2026W18-AG100007', '+2,847.50', 4847.50, 'success'],
                    ['2026-05-08 16:22','提款出账','WD-202605000007 → USDT-TRC20', '-1,500.00', 2000.00, 'warning'],
                    ['2026-05-05 10:00','结算入账','STL-2026W17-AG100007', '+2,415.80', 3500.00, 'success'],
                    ...
                    ['2026-04-25 09:00','结算入账','STL-2026W16-AG100007', '+2,180.40', 3034.20, 'success'],
                    ['2026-04-22 15:42','调整出账','风控扣减 · 玩家 PL2024582', '-180.00', 853.80, 'danger'],
                    ['2026-04-18 09:00','结算入账','STL-2026W15-AG100007', '+1,952.00', 1033.80, 'success'],
                  ].map((r, i) => (
                    <tr key={i}>
